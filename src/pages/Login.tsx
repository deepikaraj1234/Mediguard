...
import { Activity, Shield, Mail, Lock, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">MediGuard AI</h1>
          <p className="text-slate-500 mt-2">Your Enterprise-Grade Health Companion</p>
        </div>
